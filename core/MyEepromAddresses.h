...
#define MY_EEPROM_START (0u)
/** @brief Address node ID */
#define MY_EEPROM_NODE_ID_ADDRESS MY_EEPROM_START
/** @brief Address parent node ID */
#define MY_EEPROM_PARENT_NODE_ID_ADDRESS (MY_EEPROM_NODE_ID_ADDRESS + SIZE_NODE_ID)
/** @brief Address distance to GW */
#define MY_EEPROM_DISTANCE_ADDRESS (MY_EEPROM_PARENT_NODE_ID_ADDRESS + SIZE_PARENT_NODE_ID)
/** @brief Address routing table */
#define MY_EEPROM_ROUTES_ADDRESS (MY_EEPROM_DISTANCE_ADDRESS + SIZE_DISTANCE)
/** @brief Address configuration bytes sent by controller */
#define MY_EEPROM_CONTROLLER_CONFIG_ADDRESS (MY_EEPROM_ROUTES_ADDRESS + SIZE_ROUTES)
/** @brief Personalization checksum (set by SecurityPersonalizer.ino) */
#define MY_EEPROM_PERSONALIZATION_CHECKSUM_ADDRESS (MY_EEPROM_CONTROLLER_CONFIG_ADDRESS + SIZE_CONTROLLER_CONFIG)
/** @brief Address firmware type */
#define MY_EEPROM_FIRMWARE_TYPE_ADDRESS (MY_EEPROM_PERSONALIZATION_CHECKSUM_ADDRESS + SIZE_PERSONALIZATION_CHECKSUM)
/** @brief Address firmware version */
#define MY_EEPROM_FIRMWARE_VERSION_ADDRESS (MY_EEPROM_FIRMWARE_TYPE_ADDRESS + SIZE_FIRMWARE_TYPE)
/** @brief Address firmware blocks */
#define MY_EEPROM_FIRMWARE_BLOCKS_ADDRESS (MY_EEPROM_FIRMWARE_VERSION_ADDRESS + SIZE_FIRMWARE_VERSION)
/** @brief Address firmware CRC */
#define MY_EEPROM_FIRMWARE_CRC_ADDRESS (MY_EEPROM_FIRMWARE_BLOCKS_ADDRESS + SIZE_FIRMWARE_BLOCKS)
/** @brief Address signing requirement table */
#define MY_EEPROM_SIGNING_REQUIREMENT_TABLE_ADDRESS (MY_EEPROM_FIRMWARE_CRC_ADDRESS + SIZE_FIRMWARE_CRC)
/** @brief Address whitelist requirement table */
#define MY_EEPROM_WHITELIST_REQUIREMENT_TABLE_ADDRESS (MY_EEPROM_SIGNING_REQUIREMENT_TABLE_ADDRESS + SIZE_SIGNING_REQUIREMENT_TABLE)
/** @brief Address soft signing HMAC key. This is set with @ref SecurityPersonalizer.ino */
#define MY_EEPROM_SIGNING_SOFT_HMAC_KEY_ADDRESS (MY_EEPROM_WHITELIST_REQUIREMENT_TABLE_ADDRESS + SIZE_WHITELIST_REQUIREMENT_TABLE)
/** @brief Address soft signing serial key. This is set with @ref SecurityPersonalizer.ino */
#define MY_EEPROM_SIGNING_SOFT_SERIAL_ADDRESS (MY_EEPROM_SIGNING_SOFT_HMAC_KEY_ADDRESS + SIZE_SIGNING_SOFT_HMAC_KEY)
/** @brief Address RF AES encryption key. This is set with @ref SecurityPersonalizer.ino */
#define MY_EEPROM_RF_ENCRYPTION_AES_KEY_ADDRESS (MY_EEPROM_SIGNING_SOFT_SERIAL_ADDRESS + SIZE_SIGNING_SOFT_SERIAL)
/** @brief Address node lock counter. This is set with @ref SecurityPersonalizer.ino */
#define MY_EEPROM_NODE_LOCK_COUNTER_ADDRESS (MY_EEPROM_RF_ENCRYPTION_AES_KEY_ADDRESS + SIZE_RF_ENCRYPTION_AES_KEY)
/** @brief First free address for sketch static configuration */
#define MY_EEPROM_LOCAL_CONFIG_ADDRESS (MY_EEPROM_NODE_LOCK_COUNTER_ADDRESS + SIZE_NODE_LOCK_COUNTER)
